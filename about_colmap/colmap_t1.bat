...
colmap model_converter --input_path %DATASET_PATH%/dense/sparse --output_path %DATASET_PATH%/dense/sparse --output_type TXT
colmap model_converter --input_path %WORKING_PATH%\sparse\1 --output_path %WORKING_PATH%\sparse\1 --output_type TXT
:: colmap model_converter --input_path %DATASET_PATH%/dense/sparse --output_path %DATASET_PATH%/dense/sparse --output_type TXT
